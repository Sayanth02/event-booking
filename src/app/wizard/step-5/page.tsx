    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div className="space-y-2 text-sm text-gray-700">
            <p><span className="font-medium">Bride Side</span></p>
            <p><span className="font-medium">Events:</span></p>
            <p><span className="font-medium">Guests:</span> {eventDetails.guestCount || "Not specified"}</p>
            <p><span className="font-medium">Budget:</span> {eventDetails.budgetRange || "Not specified"}</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-lg font-semibold text-gray-900">Schedule & Crew</h3>
          </div>
          <div className="space-y-3 text-sm text-gray-700">
            {selectedFunctions.map((fn, idx) => (
              <div key={fn.id}>
                <p className="font-medium">{idx === 0 ? 'Main Event' : fn.name}: {fn.startTime} - {fn.endTime}</p>
              </div>
            ))}
            <div className="mt-3 pt-3 border-t">
              <p className="font-medium">Main Event Crew:</p>
              <p className="flex items-center gap-1">
                <Camera className="w-4 h-4" /> {totalPhotographers} Photographer(s)
              </p>
              <p className="flex items-center gap-1">
                <Video className="w-4 h-4" /> {totalCinematographers} Cinematographer(s)
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-lg font-semibold text-gray-900">Albums & Add-ons</h3>
          </div>
          <div className="space-y-3 text-sm text-gray-700">
            <div>
              <p className="font-medium">Album: {ALBUM_TYPES.find((t) => t.value === albumConfig.type)?.label || albumConfig.type}</p>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Payment Terms & Confirmation</h3>
