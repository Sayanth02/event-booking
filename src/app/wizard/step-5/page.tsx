              ...
              <div className="space-y-2 text-sm">
                <p>
                  ...
                  <span className="text-gray-900">
                    {clientInfo.fullName || "Not provided"}
                  </span>
                </p>
                <p>
                ...
                <p>
                  ...
                  <span className="text-gray-900">
                    {clientInfo.currentLocation || "Not provided"}
                  </span>
                </p>
              </div>
            </div>
            <div className="bg-white rounded-lg p-4">
              ...
              <div className="space-y-2 text-sm">
                <p>
                  ...
                  <span className="text-gray-900">
                    {eventDetails.bookingType || "Not selected"}
                  </span>
                </p>
                <p>
                  <span className="font-medium text-gray-700">
            ...
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-green-600 font-medium">
                  Total Cinematographers
                </p>
                <p className="text-3xl font-bold text-green-900">
                  {totalCinematographers}
                </p>
              </div>
          ...
          {loading ? (
            ...
            <div className="flex items-center justify-between p-4 border rounded-lg">
              <div>
                ...
                <p className="text-lg font-medium text-gray-900">
                  {complimentaryItemOptions.find(
                    (c) => c.value === complimentaryItem
                  )?.label || complimentaryItem}
                </p>
            ...
            <div className="text-sm text-gray-500">
              No complimentary item selected
            </div>
          )}
        </div>
